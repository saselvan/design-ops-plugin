...
**Read:** `skills/design/templates/research.md` for full process and output format.
...
**Read:** `skills/design/templates/research-validation.md` for validation prompts.
...
**Read:** `skills/design/templates/constraints.md` for full template.
...
**Read:** `skills/design/templates/persona.md` for template.
...
**Read:** `skills/design/templates/journey.md` for full template.
...
**Read:** `skills/design/templates/journey-validation.md` for validation prompts.
...
**Check domain libraries:** `skills/design/domains/{domain}.md`
**Read:** `skills/design/templates/tokens.md` for template.
...
**Read:** `skills/design/templates/visual-targets.md` for template.
...
**Read:** `skills/design/templates/spec.md` for full template.
...
**Read:** `skills/design/templates/spec-validation.md` for validation prompts.
...
**Read:** `skills/design/templates/visual-validation.md` for validation prompts.
...
**Read:** `skills/design/templates/test.md` for template.
...
**Read:** `skills/design/templates/test-validation.md` for validation prompts.
...
**Read:** `skills/design/zeroshot/zeroshot-design-cluster.md` for visual validation cluster config.
...
**Read:** `skills/design/templates/retrospective.md` for template.
...
**Read:** `skills/design/zeroshot/zeroshot-design-cluster.md` for setup and usage.
